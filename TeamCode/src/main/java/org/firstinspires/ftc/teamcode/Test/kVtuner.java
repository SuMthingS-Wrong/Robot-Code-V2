...
public class kVtuner extends CommandOpMode {
    private Button set1000, set2000, set5000, decAngle, coarse, fine, extrafine, extraextrafine, set4000, set3000;
    GamepadEx driverOp;
    TelemetryData telemetryData;

    kVSubsystem m_subsystem;
    int[] rpms = {1000,2000, 3000, 4000, 5000};
    public void initialize(){
        super.reset();
        telemetryData = new TelemetryData(telemetry);
        driverOp = new GamepadEx(gamepad1);
        m_subsystem = new kVSubsystem(hardwareMap);
