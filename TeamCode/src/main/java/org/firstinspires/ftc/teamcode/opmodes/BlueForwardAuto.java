...
public class BlueForwardAuto extends CommandOpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(117.68224299065422, 128.67289719626166, Math.toRadians(45)).mirror();
    private final Pose pickup1Pose = new Pose(120.14953271028038, 59.10280373831775, Math.toRadians(0)).mirror();
    private final Pose pickup1Control = new Pose(84.49532710280371, 82.86915887850468).mirror();
    private Pose shoot1 = new Pose(97.00000000000001, 90.06542056074771).mirror();
    private final Pose pickup2 = new Pose(120.14953271028038, 59.10280373831775, Math.toRadians(0)).mirror();
    private final Pose pickup2Control = new Pose(191.46491256752866, 56.35276302654658).mirror();

    private Pose shoot2 = new Pose(90.49532710280374, 83.33644859813084).mirror();
    private final Pose classifier = new Pose(132.15887850467288, 60.803738317756995, Math.toRadians(21)).mirror();
    ...
    public void buildPaths() {
        shoot1 = shoot1.setHeading(ShooterFunctions.getAlignedHeading(shoot1, ShooterConstants.GOAL_POS_BLUE));
        shoot2 = shoot2.setHeading(ShooterFunctions.getAlignedHeading(shoot2, ShooterConstants.GOAL_POS_BLUE));
