...
public class RedBackAuto extends CommandOpMode {
    ...
    private final Pose startPose = new Pose(56.22429906542056, 7.6, Math.toRadians(90)).mirror();
    private final Pose pickup1Pose = new Pose(7.327102803738322, 7.738317757009346, Math.toRadians(180)).mirror();
    private final Pose pickup2Pose = new Pose(23.719626168224305, 35.98130841121495, Math.toRadians(180)).mirror();
    private final Pose pickup2Control = new Pose(56.808411214953274,38.64485981308411).mirror();


    private final Pose parkPose = new Pose(56.22429906542056, 30.39252336448599, Math.toRadians(90)).mirror();
    ...
    public void buildPaths() {
        scorePose = startPose.setHeading(ShooterFunctions.getAlignedHeading(startPose, ShooterConstants.GOAL_POS_RED));
