...
//                }), shooter));
//        decreaseAngleButton = (new GamepadButton(driverOp, GamepadKeys.Button.DPAD_DOWN))
//                .whileHeld(new InstantCommand((()-> {
//                    shooter.decreaseAngle();
//                }), shooter));
//        increaseVelocityButton = (new GamepadButton(driverOp, GamepadKeys.Button.DPAD_RIGHT))
//                .whileHeld(new InstantCommand((()-> {
//                    shooter.increaseRPM();
//                }), shooter));
//        decreaseVelocityButton = (new GamepadButton(driverOp, GamepadKeys.Button.DPAD_LEFT))
//                .whileHeld(new InstantCommand((()-> {
//                    shooter.decreaseRPM();
//                }), shooter));
