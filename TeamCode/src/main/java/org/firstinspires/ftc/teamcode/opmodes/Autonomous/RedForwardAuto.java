...
@Autonomous
public class RedForwardAuto extends CommandOpMode {
    private Follower follower;
    TelemetryData telemetryData = new TelemetryData(telemetry);
   Shooting ShooterFunctions = new Shooting();

    // Poses
    private Pose scorePreload = new Pose(90.3177570093458, 84.71028037383178);
    ...
    private Pose shoot1 = new Pose(97.00000000000001, 90.06542056074771);
    ...
    private Pose shoot2 = new Pose(90.49532710280374, 83.33644859813084);
    private final Pose classifier = new Pose(132.15887850467288, 60.803738317756995, Math.toRadians(21));
    private final Pose parkPose = RobotConstants.RED_FORWARD_PARK_POSE;


    // Path chains
    private PathChain grabPickupReusable, grabPickup1, grabPickup2, grabPickup3;
    private PathChain startingShot, scorePickup1, scorePickup2, scorePickup3, park;

    public void buildPaths() {
        scorePreload = scorePreload.setHeading(ShooterFunctions.getAlignedHeading(scorePreload, RobotConstants.GOAL_POS_RED));
        shoot1 = shoot1.setHeading(ShooterFunctions.getAlignedHeading(shoot1, RobotConstants.GOAL_POS_RED));
        shoot2 = shoot2.setHeading(ShooterFunctions.getAlignedHeading(shoot2, RobotConstants.GOAL_POS_RED));
